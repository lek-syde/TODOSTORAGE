...
public interface StorageSpaceRepo extends JpaRepository<StorageSpace, Integer > {
	...
	@Query("Select a from StorageSpace a  left join a.information b  on a.information.StoreId=b.StoreId where a.information.StoreId=?1 ")
	StorageSpace findByInformationid(int id);
